...
#define SimpleError(x, y) SimpleError((x), (y), __FILE__, __LINE__)
  ...
  */
   ...
   */
    ...
    double solveObjectiveFeasibilityProblem(size_t n,const double * x_bar,const int *inds, double alpha, double objectiveScalingFactor, double distanceScalingFactor);
   ...
   */
    double solveFeasibilityProblem(size_t n, const double * x_bar, const int* inds, int L, double cutoff);
   ...
   * \param cutoff objective function value of a known integer feasible solution
   */
    double solveFeasibilityProblem(size_t n, const double * x_bar, const int* ind, int L);
